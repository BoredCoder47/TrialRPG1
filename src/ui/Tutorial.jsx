        ...
        <article className="space-y-6">
          <section className="panel fantasy-border p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-300">
              ...
              your save file as JSON. Open worldmap, enter region, enter zone, fight some normal enemies first , then enter dungeon. Boss unlocks on clearing all other tiles after fighting tiles. after boss dies, claim rewards button. Goblin is a testing enemy, it will high experience to level up fast to test
            </p>
          </section>
