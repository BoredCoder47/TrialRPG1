...
const SPELL_CHOICE_TABLE = {
  // EARLY GAME – identity forming
  2: ["multi-shot", "heal"],                // physical vs support
  4: ["rock-shot", "water-bolt"],           // elemental branch
  6: ["ice-spike", "wind-screech"],         // first AOE option

  // BUILD DEFINING
  8: ["shield", "shadow-bolt"],             // defense vs dark damage
  10: ["cleave", "piercing-shot"],          // physical specialization
  12: ["gel-burst", "burn"],                // DOT focus

  // MID GAME POWER
  15: ["phase-strike", "lava-burst"],       // burst vs heavy magic
  18: ["greater-heal", "spectral-wave"],    // sustain vs AOE dark
  20: ["ground-slam", "tide-crush"],        // physical AOE upgrade

  // HIGH TIER
  23: ["void-blast", "ember-storm"],        // strong AOE magic
  26: ["phase-shield", "electric-storm"],   // defensive vs stun build

  // LATE GAME SPIKE
  30: ["inferno", "tsunami"],               // end-tier nukes
};
